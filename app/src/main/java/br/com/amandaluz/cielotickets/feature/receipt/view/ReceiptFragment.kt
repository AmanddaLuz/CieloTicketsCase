...
import br.com.amandaluz.cielotickets.feature.receipt.view.adapter.ReceiptItemAdapter
import br.com.amandaluz.cielotickets.feature.receipt.ReceiptUiModel
...
import br.com.amandaluz.cielotickets.feature.receipt.viewmodel.ReceiptViewModelFactory
...
class ReceiptFragment : Fragment(R.layout.fragment_receipt) {
    ...
    private fun setView() {
        ...
        binding.toolbar.setNavigationOnClickListener {
            findNavController().navigate(R.id.action_receipt_to_history)
        }
